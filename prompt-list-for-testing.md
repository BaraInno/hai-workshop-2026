# Alle Workshop-Prompts (zum Testen in ChatGPT)

Übersicht aller Prompts, die auf der Website zum Kopieren angeboten werden. Reihenfolge = empfohlene Testreihenfolge.

---

## 1. Zielbild – KI-Sparringpartner (zielbild.html, Step 1)

```
Du bist mein KI-Sparringpartner und hilfst mir herauszufinden, wobei du mir als KI im Alltag am meisten helfen könntest.

Dein Vorgehen (für ChatGPT):
...
## 2. Zielbild – Foto & Listen zusammenführen (zielbild.html, Step 3)

```
Hier ist ein Foto meiner handgeschriebenen Liste mit Aufgaben, die ich KI geben möchte.
...
5. Gib mir am Ende eine kurze Zusammenfassung: Wie viele Punkte insgesamt? Wie viele Überschneidungen?
```

*Hinweis: Im echten Workshop wird ein Foto mitgeschickt. Zum Test: ohne Foto ausprobieren oder mit Platzhalter-Text.*

---

## 3. Fitness – Erklärbär (fitness.html, Step 3)

```
Du bist mein persönlicher Erklärbär – ein freundlicher Erklärassistent, der komplexe KI- und Technologie-Konzepte verständlich macht.
...
## 4. Fitness – Geburtstagskarte 5.1 (einfacher Prompt)

```
Schreib mir einen Kurztext für eine 30er Geburtstagskarte für eine Freundin.
```
...
Bevor du loslegst: Was musst du von mir wissen, damit die Karte wirklich großartig wird?
```
...
```
Ich habe dir Beispiel-E-Mails aus meinem Gesendet-Ordner angehängt. Diese E-Mails repräsentieren meinen persönlichen Schreibstil.
...
Erstelle die Analyse als strukturierte, übersichtliche Liste.
```

*Hinweis: Normalerweise mit E-Mail-Anhang. Ohne Anhang: ChatGPT wird vermutlich nach Anhang fragen oder Beispiel anbieten.*
...
```
Basierend auf deiner Analyse meines Schreibstils: Erstelle einen kompakten Systemprompt für einen KI-Assistenten, der E-Mails und Texte in meinem persönlichen Stil schreibt.
...
Format: Fertig formatierter Systemprompt, den ich direkt in einen GPT-Assistenten kopieren kann.
```

*Zum Test: Oft nach Step 11 (Analyse) verwendet; ohne vorherige Analyse wird ChatGPT ggf. nach Analyse oder Beispielen fragen.*
...
**Gesamt: 13 Prompts.**  
Für den Live-Test in ChatGPT: Bei 2, 11, 12 ggf. ohne Anhang testen und Antwort (z.B. „Bitte Anhang schicken“) dokumentieren.
